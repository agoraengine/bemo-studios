...
3. **Disclosure moved off-screen (amended by Becky, August 6, 2026).** The on-screen "AI-generated presenter" chip is removed from the video frame at Becky's direction after reviewing finished lessons. Disclosure now lives at the surface level: the course description or the lesson's surrounding page states that lessons are presented by AI avatars of the founders. The original on-screen requirement is preserved in history; if lessons ever ship to surfaces without that surrounding context, this condition must be revisited before publishing there.

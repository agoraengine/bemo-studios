...
**Who presents what.** One generic stock avatar, chosen once for the series, presents every lesson (Becky, August 4, 2026, superseding the August 3 twin-for-Amplify split). No founder twin: viewers will not register the difference, and the initiative scales better without the consent-recording long-lead. The generic seat is a placeholder by design: the direction is that subject-matter-expert partners present their own areas, toward a full marketplace of expert-led lessons. Until a partner has cleared the consent bar below, the seat stays generic. The marketplace is direction, not shipped product; no lesson shows or claims it.

...
**Locked means the VO has been generated against this text.** Not locked yet. The Becky voice clone has to exist first.

---

| Time | Narration | On screen | Shot |
|---|---|---|---|
| 0:00 | *(silence, music only)* | Front page of an org running on BeMo. Caption: "Monday morning. BeMo already knows your organization." | S0 |
...
**Flag before lock:** "Where missions gain momentum" is inherited from the July 30 draft. Confirm it is the ratified tagline and not a draft line that never got promoted into canon.

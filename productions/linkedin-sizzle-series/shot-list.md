...
| R1-S8 | A real finished Amplify deliverable: the fundraising appeal letter (Maya story, gift levels, bolded ask), cropped to the letter body | screen | 0:06 | Manual screenshot from Becky, 2026-08-03 (crop at `assets/amplify.png`, full frame `amplify-full.png`); "New Horizons Youth Network" confirmed fictitious demo data by Becky, 2026-08-03 | [x] |

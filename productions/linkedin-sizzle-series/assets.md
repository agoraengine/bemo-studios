...
| Reel 8H, hero 60s 16:9 | vH9 | 2026-08-06 | Review link (HeyGen workspace asset, AC-01 pattern): https://resource2.heygen.ai/video/74314a19ddbf414d82cd6e8b05fcad73/original.mp4 · Drive master PENDING | `bemo-linkedin-sizzle-series-r8h-60s-vH9.mp4`; **the launch-week hero** (Six Tools extended; replaces v17 as the Bill/Jon share asset on Becky's approval); vH8's uncropped-screens fix plus Becky's 0:07 note: the site take refilmed with an animated camera lift so the scattered artifacts fill the frame at the open, easing to identity before the edition composes (held page framing unchanged); QA'd frame-by-frame; -16.2 LUFS integrated, -1.3 dB true peak; 1920x1080; captions burned; sidecar `bemo-linkedin-sizzle-series-r8h-60s.srt` |

...
const SEGMENTS = [
  ["a1.mp4", "Somewhere in a board meeting near you, someone is about to say the sentence that quietly disables more small nonprofits than any budget cut: we can't do advocacy, we're a 501(c)(3). This lesson unwinds that sentence. In the next five minutes you'll be able to name the four kinds of civic action, and know which of them you're free to use."],

...
- **Full-frame, never pillarboxed, never a close-up** (Lee and Becky, 2026-08-04, settled by rendered variants): full-screen presenter segments render as a **background-removed cutout on the warm-paper backdrop** (`removeBackground: true`, `background: #f6f2e9`, natural waist-up distance, no `fit: cover`). This normalizes every cast member onto one branded look regardless of their recording room. The pilot v1's white pillarboxing and v2's fit-cover close-up are the two counterexamples.

...
| Cast table | **Proposed 2026-08-05 (awaiting Becky's ratification), founders' twins by domain credibility.** Becky (operations, strategy, PR): Communications & Marketing (34), Advocacy & Civic Engagement (30), Fund Development (35), People & Leadership (35), Personal Growth (25), Featured (1) — 160 courses. Lee (product, engineering): AI for Nonprofits (25), Finance & Operations (30), Program Impact (25), Strategy & Governance (30) — 110 courses. Becky's seat: digital twin `c1b7e19979ca42d78cf0a1646497a2d7`, voice `7fa742e991de4771a83eb35b53515833`. Lee's seat: look `2fcecf2d8cd54983bbbae598828ad4bf` (landscape, no mic), voice `5661c06639514cd5a16bb4ddbeb28983`, composited off-center on the boardroom so the logo stays clear. Realism at scale: Becky's is a true video-trained digital twin; Lee's is a photo avatar, and for a few hundred lessons a video-trained twin session for Lee is the single biggest realism upgrade available; both founders' look libraries (19+ and 14) allow per-category outfit variation so the cast doesn't repeat identically across 270 videos. |
